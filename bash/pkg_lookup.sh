...
#
# Instructions:
# - Run the following one-liner on the victim:
#
...
# - Copy the file it generates back to your machine (or any machine with searchsploit)
# - Run this script, passing in the directory of the file:
